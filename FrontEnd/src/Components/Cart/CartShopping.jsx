...
export function CartShopping({cart}) {
    ...
    return (
        <>
            ...
            <div  dataset='box-cart' style={{backgroundColor: 'rgba(107, 114, 128, 0.5)'}} className='fixed left-0 top-0 right-0 bottom-0 z-[1] flex flex-col items-center justify-center shadow-2xl'>
                        ...
                        cart.length === 0
                            ...
                            :   <>
                                <div className='flex justify-end'>
                                    <button className='text-[#3e77aa] hover:text-red-500 transition p-2 sm:p-3' >Delete All</button>
                                </div>
